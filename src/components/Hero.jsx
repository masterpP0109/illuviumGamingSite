...
const Hero = () => {
  return (
   <main className=" relative w-full h-screen overflow-hidden flex justify-center mb-[10%]  ">
    ...
    muted
    playsInline
    className='w-full h-[95] object-cover absolute
    ...
    <div className='absolute bottom-40 lg:right-24 right-5 mt-24 animate-bounce sm:inline-block hidden'>
        <div className='flex flex-col items-center'>
            <div className='w-8 h-12 border-2 border-[#babaff] rounded-full flex justify-center'>
                <div className='w-1 h-3 bg-[#babaff]
                rounded-full animate-pulse pt-1'></div>
            </div>
